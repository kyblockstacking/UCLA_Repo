* **Instructions**
  ...
  * Create an `/icecreams` route. It will loop over all the ice creams and display them to the user.

  * **BONUS:** Add another property to each ice cream object for an image URL. In your handlebars template, display the image for each ice cream.

  * **BONUS:** On the `/icecreams` page, break up the ice cream flavors into two lists: cheap ice cream (anything less than $5) and expensive ice cream.
