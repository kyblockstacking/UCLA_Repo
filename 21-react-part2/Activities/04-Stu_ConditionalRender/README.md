...
* Turn one of the page components into a stateful component and make an ajax/axios call to the Bacon Ipsum API for dummy content to display on the page: <https://baconipsum.com/json-api/>
