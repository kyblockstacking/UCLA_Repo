...
class Dog extends DigitalPal {
  // a constructor isn't necessary here, because we aren't doing any unique initialization for Dogs.

  bark() {
    console.log("Pet: I am dog. Bark, bark.\n");
  }
}

// Initialize new DigitalPal
var dog = new Dog(true, false, false);
