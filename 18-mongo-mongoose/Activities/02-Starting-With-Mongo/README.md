...
If you finish early, check out the MongoDB documentation and figure out how to find users by an entry in an array. Example: find all students who have "coding" _and_ "running" as hobbies.
