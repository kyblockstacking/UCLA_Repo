...
If you finish early, check out the MongoDB documentation and figure out how to remove entries from an array. Example: remove "coding" as a hobby from everyone in the class. Yikes, must have been a bad day.
